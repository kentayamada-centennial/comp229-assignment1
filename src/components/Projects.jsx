/* Projects.jsx, Kenta Yamada, 301366037, 2024/01/27 */

import { item, wrapper } from "./Projects.module.css";
      ...
      <div className={wrapper}>
        ...
        <div className={item}>
          ...
          <p>
            ...
            Context API and React Router. The Routes were set up for four
            default pages and a search page. Also, the images were displayed
            using the Flickr API and Axios to fetch data as given in the
